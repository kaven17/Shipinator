...
export default function ReceiverPage() {
  ...
  const claimDocument = async () => {
    ...
    try {
      // Here you would implement the actual NFT minting or transferring logic
      // This would involve a smart contract interaction
      ...
      // For demonstration, we're just updating the state without actually writing to Firebase
      setClaimed(true);
    ...
    <div className="container mx-auto p-6 mt-20">
      ...
      <Card className="mb-8">
        <CardHeader>
          ...
          <CardDescription>Enter the shipment ID provided by the shipper</CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <h3 className="font-medium text-gray-500 mb-2">Route Information</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
            ...
            <div>
              <h3 className="font-medium text-lg mb-4">Shipment Document</h3>
              <div className="bg-gray-50 p-4 rounded-lg">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                  <div className="flex items-center mb-4 md:mb-0">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Stored securely on IPFS</p>
                    </div>
                  </div>
                ...
                {!isLoggedIn || !isWeb3Connected ? (
                  ...
                  <div className="mt-4 p-3 bg-green-50 text-green-800 rounded-lg text-sm">
                    ...
                    Document claimed successfully! You now have access to view and download this document.
                  </div>
                ) : null}
              </div>
            </div>
        ...
        <Card>
          <CardContent className="py-10">
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <p className="text-gray-500 max-w-md">
                Enter the shipment ID above to access your shipment documents.
